...
describe("Auto-Checkpoint Hook", () => {
  ...
  describe("Hook Execution", () => {
    ...
    it("should use message as checkpoint name", async () => {
      ...
      expect(mockCheckpointService.saveAgentCheckpoint).toHaveBeenCalledWith("Custom checkpoint name", mockAgent);
    });
    ...
    it("should handle empty message", async () => {
      ...
      expect(mockCheckpointService.saveAgentCheckpoint).toHaveBeenCalledWith("", mockAgent);
    });
  });
  ...
  describe("Error Handling", () => {
    ...
    it("should handle service errors", async () => {
      ...
      expect(hook?.callback(requestData, mockAgent)).rejects.toThrow("Service error");
    });
    ...
    it("should handle checkpoint service startup failures", async () => {
      ...
      expect(hook?.callback(requestData, mockAgent)).rejects.toThrow("Service not initialized");
    });
  });
  ...
  describe("Service Integration", () => {
    ...
    it("should pass correct parameters to service", async () => {
      ...
      expect(mockCheckpointService.saveAgentCheckpoint).toHaveBeenCalledWith(expectedCheckpointName, mockAgent);
    });
  });
